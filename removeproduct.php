  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="addproduct.php" method="post">
        <h2 class="form-signin-heading">Remove Product</h2>

        <input type="text" id="Name" class="form-control" placeholder="Product Name" required autofocus>
